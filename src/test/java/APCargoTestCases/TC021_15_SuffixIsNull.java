...
public class TC021_15_SuffixIsNull {
	...
	public static void suffixIsNull() {
		...
		System.out.println("TC021.15_[CustMgmt] [Customer Record_Create Customer Record] - Input Validations on the "
		...
		// 3. Left the Suffix field as null/blanked
