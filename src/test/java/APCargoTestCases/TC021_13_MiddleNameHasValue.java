...
public class TC021_13_MiddleNameHasValue {
	...
	public static void middleNameHasValue() {
		...
		System.out.println("TC021.13_[CustMgmt] [Customer Record_Create Customer Record] - Input Validations on the "
				+ "fields - Personal customer");
		System.out.println("- Middle Name has value");
		...
		customerInfoFields.enterMiddleName(driver, "Alonzo");
