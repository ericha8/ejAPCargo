...
public class TC021_22_ChargeAccountIsNOandTINIsAbove12Digits {
	
	private static WebDriver driver = null;

	public static void main(String[] args) {
		chargeAccountIsNOandTINIsAbove12Digits();
		
	}
	
	public static void chargeAccountIsNOandTINIsAbove12Digits() {
		...
		System.out.println("TC021.22_[CustMgmt] [Customer Record_Create Customer Record] - Input Validations on the "
				+ "fields - Personal customer");
		System.out.println("- Charge Account is 'NO' and TIN is above 12 digits");
		...
		// 4. Enter TIN value above 12 digits
		customerInfoFields.enterTIN(driver, "131210020091312");
		...
		customerInfoVerify.chargeAccNOtinAboveTwelveErrorMessage(driver);
