...
public class TC021_27_ChargeAccountIsYesAndTINIsAbove12Digits {
	
	private static WebDriver driver = null;

	public static void main(String[] args) {
		chargeAccountIsYesAndTINIsAbove12Digits();
		
	}
	
	public static void chargeAccountIsYesAndTINIsAbove12Digits() {
		...
		System.out.println("TC021.27_[CustMgmt] [Customer Record_Create Customer Record] - Input Validations on the "
				+ "fields - Personal customer");
		System.out.println("- Charge Account is 'Yes' and TIN is above 12 digits");
		...
		customerInfoVerify.chargeAccYesTinAboveTwelveErrorMessage(driver);
