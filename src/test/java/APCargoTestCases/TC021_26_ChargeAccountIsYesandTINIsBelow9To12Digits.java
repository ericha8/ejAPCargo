...
public class TC021_26_ChargeAccountIsYesandTINIsBelow9To12Digits {
	
	private static WebDriver driver = null;

	public static void main(String[] args) {
		chargeAccountIsYesandTINIsBelow9To12Digits();
		
	}
	
	public static void chargeAccountIsYesandTINIsBelow9To12Digits() {
		...
		System.out.println("TC021.26_[CustMgmt] [Customer Record_Create Customer Record] - Input Validations on the "
				+ "fields - Personal customer");
		System.out.println("- Charge Account is 'Yes' and TIN is below 9-12 digits");
		...
		customerInfoFields.enterTIN(driver, "13022092");
		...
		customerInfoVerify.chargeAccYesTinBelowNineToTwelveErrorMessage(driver);
