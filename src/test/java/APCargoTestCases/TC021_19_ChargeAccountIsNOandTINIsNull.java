...
public class TC021_19_ChargeAccountIsNOandTINIsNull {
	
	private static WebDriver driver = null;

	public static void main(String[] args) {
		chargeAccountIsNOandTINIsNull();
		
	}
	
	public static void chargeAccountIsNOandTINIsNull() {
		...
		System.out.println("TC021.19_[CustMgmt] [Customer Record_Create Customer Record] - Input Validations on the "
				+ "fields - Personal customer");
		System.out.println("- Charge Account is 'NO' and TIN is Null");
